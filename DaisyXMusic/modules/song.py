...
@Client.on_message(filters.command("2song") & ~filters.channel)
...
@Client.on_message(filters.command("2saavn") & ~filters.edited)
...
@Client.on_message(filters.command("2deezer") & ~filters.edited)
...
@Client.on_message(filters.command(["2vsong", "2video"]))
